            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <img loading="lazy" src="build/img/blog1.jpg" alt="Primera entrada de blog">
                    </picture>
                </div>
            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <img loading="lazy" src="build/img/blog2.jpg" alt="Segunda entrada de blog">
                    </picture>
                </div>
                <div class="texto-entrada">
                    <a href="entrada.php">
            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <img loading="lazy" src="build/img/blog3.jpg" alt="Tercera entrada de blog">
                    </picture>
                </div>
                <div class="texto-entrada">
                    <a href="entrada.php">
            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <img loading="lazy" src="build/img/blog4.jpg" alt="Cuarta entrada de blog">
                    </picture>
                </div>
                <div class="texto-entrada">
                    <a href="entrada.php">
